...
<form class="form-horizontal"  action = "process_newuser.php">
<fieldset>

<!-- Form Name -->
<legend>Please put in a username</legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="submit" name="submit" class="btn btn-danger">Create new user</button>
  </div>
</div>
